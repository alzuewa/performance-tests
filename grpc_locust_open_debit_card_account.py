...
class OpenDebitCardAccountScenarioUser(User):
    ...
    def on_start(self) -> None:
        self.users_gateway_client = build_users_gateway_locust_grpc_client(environment=self.environment)
        self.accounts_gateway_client = build_accounts_gateway_locust_grpc_client(environment=self.environment)
